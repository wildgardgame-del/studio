...
export default function Home() {
  ...
  const featuredGames = useMemo(() => {
    ...
    // Filter based on age verification and user preference
    if (!isAgeVerified || !showAdultContent) {
        return allGames.filter(game => !game.isAdultContent);
    }
    
    // If age verified and toggle is on, show all approved games
    return allGames;
  }, [allGames, isAgeVerified, showAdultContent]);
