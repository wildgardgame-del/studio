...
function MyGamesPageContent() {
    ...
    const myGamesQuery = useMemoFirebase(() => {
        ...
        // Query for games submitted by the current user, ordered by submission time.
        // No filtering for adult content is applied here. The developer should see all their submissions.
        return query(
                     ...
                     <div className="flex items-center gap-4 mb-8">
                        <Button asChild variant="outline" size="icon">
                            <Link href="/dev/dashboard">
                                ...
                                <span className="sr-only">Back to Dev Dashboard</span>
                            </Link>
                        </Button>
                        <div>
