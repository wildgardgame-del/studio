        ...
        <div className="container">
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1 lg:col-span-1 space-y-4">
              ...
              <div className="space-y-2">
                <Button size="lg" className="w-full" onClick={() => handleAddToCart(game)} disabled={gameIsPurchased}>
                   <ShoppingCart className="mr-2" /> {gameIsPurchased ? 'Na Biblioteca' : `Comprar por $${game.price.toFixed(2)}`}
                </Button>
            ...
            <div className="md:col-span-2 lg:col-span-3 space-y-6">
               ...
               <div>
                 <h2 className="text-2xl font-bold font-headline mb-4">Capturas de Ecrã</h2>
                  <Carousel
                    opts={{
                      align: "start",
                      loop: true,
                    ...
                    <CarouselContent>
                      {(game.screenshots || []).map((ss, index) => (
                        <CarouselItem key={index} className="md:basis-1/2">
                          <Image src={ss} alt={`Captura de ecrã ${index + 1} de ${game.title}`} width={1920} height={1080} className="rounded-lg aspect-video object-cover" />
                        </CarouselItem>
                      ))}
                    </CarouselContent>
